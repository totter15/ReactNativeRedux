...
import {StyleSheet, View, SafeAreaView,FlatList, TextInput, Text, Pressable} from 'react-native';
import useTodosActions from '../hooks/useTodosActions';
import useTodos from '../hooks/useTodos';
import { remove, toggle } from '../slices/todos';
...
function Todos (){
    ...
    return (
        <FlatList style={styles.todos} data={todos} renderItem={({item})=>(
...
function TodoInput(){
    ...
    return(
        <View style={styles.inputWrapper}>
            <TextInput style={styles.input} placeholder="할일을 입력하세요" value={text} onChangeText={setText} />
